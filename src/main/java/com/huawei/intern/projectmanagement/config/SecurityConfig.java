package com.huawei.intern.projectmanagement.config;



import com.huawei.intern.projectmanagement.security.JwtAuthenticationEntryPoint;
import com.huawei.intern.projectmanagement.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity httpSecurity)throws Exception{
        httpSecurity.cors().and()
                ...
                .authorizeRequests()
                .antMatchers("/api/projects/getall")
                .permitAll()
                .antMatchers("/auth/**")
                .permitAll()
